...
class _FormularioWidgetState extends State<FormularioWidget>
  ...
  void initState() {
    ...
    _model.contactocelularController ??= TextEditingController();
    _model.contactocelularFocusNode ??= FocusNode();
                                                            ...
                                                            children: [
                                                              ...
                                                              Padding(
                                                                ...
                                                                child:
                                                                    TextFormField(
                                                                  controller: _model
                                                                      .contactocelularController,
                                                                  focusNode: _model
                                                                      .contactocelularFocusNode,
                                                                  autofocus:
                                                                      true,
                                                                  textInputAction:
                                                                      TextInputAction
                                                                  ...
                                                                  style: FlutterFlowTheme.of(
                                                                      ...
                                                                      .bodyMedium,
                                                                  validator: _model
                                                                      .contactocelularControllerValidator
                                                                      .asValidator(
                                                                          context),
                                                                ),
                                                              ),
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          await PropiedadesRecord
                                                                            ...
                                                                            ...createPropiedadesRecordData(
                                                                              ...
                                                                              pais: (_model.paisFocusNode?.hasFocus ?? false).toString(),
                                                                              codigoPostal: (_model.cpFocusNode?.hasFocus ?? false).toString(),
                                                                              estado: _model.estadoController.text,
                                                                              municipio: _model.municipioController.text,
                                                                              colonia: (_model.coloniaFocusNode?.hasFocus ?? false).toString(),
                                                                              calle: (_model.calleFocusNode?.hasFocus ?? false).toString(),
                                                                              numExtInt: (_model.numintextFocusNode?.hasFocus ?? false).toString(),
                                                                              tipoPropiedad1: '',
                                                                              ...
                                                                              mascotas: (_model.mascotasValue != null && _model.mascotasValue != '').toString(),
                                                                              contactoNombre: _model.contactonombreController.text,
                                                                              contactoNumero: _model.contactocelularController.text,
                                                                              oferta: _model.tipodeofertaValue,
                                                                              idPropiedad: currentUserReference?.id,
                                                                              propiedadImagenes: _model.uploadedFileUrl,
                                                                            ),
                                                                            ...mapToFirestore(
                                                                              {
                                                                          ...
                                                                          context
                                                                              .pushNamed('PerfilPublicacionesCopy');
                                                                        },
                                                                        text:
                                                                            'Publicar',
                                                                        options:
