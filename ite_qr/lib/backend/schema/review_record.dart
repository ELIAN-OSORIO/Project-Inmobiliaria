...
class ReviewRecord extends FirestoreRecord {
  ...
  // "propiedadRef" field.
  DocumentReference? _propiedadRef;
  DocumentReference? get propiedadRef => _propiedadRef;
  bool hasPropiedadRef() => _propiedadRef != null;
  ...
  void _initializeFields() {
    _propiedadRef = snapshotData['propiedadRef'] as DocumentReference?;
...
Map<String, dynamic> createReviewRecordData({
  DocumentReference? propiedadRef,
...
class ReviewRecordDocumentEquality implements Equality<ReviewRecord> {
  ...
  bool equals(ReviewRecord? e1, ReviewRecord? e2) {
    return e1?.propiedadRef == e2?.propiedadRef && e1?.userRef == e2?.userRef;
  }

  @override
  int hash(ReviewRecord? e) =>
      const ListEquality().hash([e?.propiedadRef, e?.userRef]);
